...
When encrypting data, the Handle Gateway returns a `handleProof` - a signed EIP-712
payload that proves the handle was created by a legitimate Handle Gateway. This proof

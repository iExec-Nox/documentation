...
<a href="https://demo.noxprotocol.io" target="_blank" rel="noopener noreferrer" class="inline-flex items-center gap-2 rounded-lg px-4 py-2.5 text-sm font-medium text-white! bg-[var(--vp-c-brand-1)] no-underline! transition-all duration-200 my-4 hover:bg-[var(--vp-c-brand-2)] hover:-translate-y-px">

...
practice. It connects to the {{ chainName }} testnet and lets you wrap,
...
- A small amount of **{{ chainName }} ETH** for gas fees
- Some testnet tokens to wrap. The app includes a faucet to get USDC and RLC

<!-- prettier-ignore -->
::: tip No real funds involved
The demo runs entirely on **{{ chainName }}** (testnet). All tokens are free

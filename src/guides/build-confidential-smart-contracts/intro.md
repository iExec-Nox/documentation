---
title: Introduction
description: Introduction to building confidential smart contracts
---
...
- How to use Hardhat or Foundry with Nox
- How to create and deploy confidential smart contracts
- Best practices for privacy-preserving contracts

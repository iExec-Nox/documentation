...
::: tip Before you deploy Nox runs on **Arbitrum Sepolia**. Make sure your
wallet is connected to the right network and you have testnet ETH. See
[Networks & Faucets](/getting-started/networks). :::
